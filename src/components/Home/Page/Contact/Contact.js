...
const Contact = () => {
  ...
  return (
    <div id="contact">
      <section className="p-20 bg-gradient-to-t from-blue-100 via-blue-200 to-white py-20 lg:py-[120px] overflow-hidden relative z-10">
        <div className="container">
          <div className="flex flex-wrap -mx-4 lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                <span className="  mb-4 text-base font-semibold text-primary">
                  Contact Us
                </span>
              ...
              <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full p-3 text-white transition border rounded border-primary bg-blue-900 hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
